...
public class StudentCustomRowMapper implements RowMapper<Student> {
	...
	public Student mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		StudentRowMapper stRowMapper = new StudentRowMapper();
		
		if(rs!=null){
			student = stRowMapper.mapRow(rs, rowNum);
			student.setStudExists(rs.getBoolean("stud_exists"));
			student.setUserExists(rs.getBoolean("user_exists"));
		}
